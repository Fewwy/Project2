...
Совет как начать работу!!!!
Ваша новая страница будет использовать те же файлы импортов, что и основные три страницы (index.html, generic.html, elements.html)
Начните с того, что скопируйте generic.html себе, переименуйте, затем начинайте отрезать от него лишние куски (то что вам не нужно). В итоге у вас останется шапка, меню, футер и импорты. Далее начинайте добавлять своё. Если нужно добавить свои стили - ниже описано как это надо сделать.
...
на ней показаны примеры стилей, чтобы вы лучше представляли как выглядит заголовок и прочее.
assets folder >
